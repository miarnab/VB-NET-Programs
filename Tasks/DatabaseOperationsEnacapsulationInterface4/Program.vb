...
Public Class Student
    ...
    End Sub
    Public Sub DatabaseTableSort() Implements College.DatabaseTableSort
        Dim query As String = "Select * From student Order By year DESC"
